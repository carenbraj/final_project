...
//function to set parameters
  ...
  function mailRecommendation(){

  var to = encodeURIComponent(document.getElementById("recommendation-form-email").value);
  var subject = encodeURIComponent(document.getElementById("recommendation-form-subject").value);
  var content = encodeURIComponent(document.getElementById("recommendation-form-content").value);
  window.location = "mailto:"+to+"?subject="+subject+"&body="+content;
}
